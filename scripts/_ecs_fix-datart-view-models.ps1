...
$h = (Invoke-WebRequest -Uri "$DatartUrl/api/v1/users/login" -Method Post -ContentType "application/json" -Body '{"username":"admin","password":"123456"}' -UseBasicParsing).Headers['Authorization']
