...
/** v1：按小时统计平均电池包电压与平均充电电流 → t_voltage_current */
public class V1VoltageCurrentHourly extends Configured implements Tool {

    public static class V1Mapper extends BatteryMapper {
        @Override
    ...
    public int run(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("Usage: V1VoltageCurrentHourly <input> <output>");
            return 1;
        }
        Job job = JobBuilder.createJob(getConf(), V1VoltageCurrentHourly.class,
                "v1_voltage_current_hourly", V1Mapper.class, Avg2Reducer.class);
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new Configuration(), new V1VoltageCurrentHourly(), args));
    }
}
