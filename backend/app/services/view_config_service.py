...
DEFAULT_VIEWS: list[ChartViewConfig] = [
    ...
    ChartViewConfig(chart_key="v6", title="组电压变化率", chart_type="line", data_source="/bi/voltage-current-relation", drill_route="/bda1", grid_area="v6", sort_order=6),
    ChartViewConfig(chart_key="v7", title="电池状态温度统计", chart_type="bar", data_source="/bi/soc-temperature", drill_route="/bda2", grid_area="v7", sort_order=7),
