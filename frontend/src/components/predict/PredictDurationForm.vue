<template>
  <el-form label-width="120px" @submit.prevent="submit">
    ...
    <el-button type="primary" native-type="submit" :loading="loading">预测时长</el-button>
  </el-form>
</template>
...
const form = reactive({ kwh_total: 30, start_time: 8, end_time: 10, weekday: 'Mon', platform: 'android', facility_type: 3, station_id: 0, charging_fees: 0 })
